...
freqs, pos, neg = build_freqs(train_x, train_y)

#%%
pos_tweets = [ "I am happy because I am learning NLP",
               "I am happy, not sad." ]

neg_tweets = [ "I am sad, I am not learning NLP",
               "I am sad, not happy." ]
...
freqs, pos, neg = build_freqs(tweets, labels)
